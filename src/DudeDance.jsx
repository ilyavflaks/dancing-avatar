...
Command: npx gltfjsx@6.1.4 ./public/dudeDance.glb
*/

import React, { useRef, useEffect } from "react"; /* highlight-line */
import { useGLTF, useAnimations } from "@react-three/drei"; /* highlight-line */

export default function DudeDance({ ...props }) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/dudeDance.glb");
